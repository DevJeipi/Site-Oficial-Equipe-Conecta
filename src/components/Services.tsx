        ...
        <ul className="flex flex-col gap-6 w-full md:w-3/5">
          <li className="flex flex-col md:flex-row items-center gap-6 bg-[#DDE1EA] p-9 rounded-2xl">
            ...
            <div>
              ...
              <p>
                Criamos campanhas estratégicas no Google Ads, Meta Ads e outras
                redes para alcançar o público certo e maximizar conversões.
              </p>
            </div>
          </li>
          <li className="flex flex-col md:flex-row items-center gap-6 bg-[#DDE1EA] p-9 rounded-2xl">
          ...
          <li className="flex flex-col md:flex-row items-center gap-6 bg-[#DDE1EA] p-9 rounded-2xl">
            ...
            <div>
              ...
              <p>
                Definimos a melhor forma de apresentar sua marca no mercado para
                atrair e conectar o público certo.
              </p>
            </div>
          </li>
        </ul>
        ...
        <ul className="flex flex-col gap-6 w-full md:w-3/5">
          ...
          <li className="flex flex-col md:flex-row items-center gap-6 bg-[#DDE1EA] p-9 rounded-2xl">
            ...
            <div>
              ...
              <p>
                Produzimos imagens e vídeos estratégicos para aumentar o impacto
                das suas campanhas.
              </p>
            </div>
          </li>
        ...
        <ul className="flex flex-col gap-6 w-full md:w-3/5">
          ...
          <li className="flex flex-col md:flex-row items-center gap-6 bg-[#DDE1EA] p-9 rounded-2xl">
            ...
            <div>
              ...
              <p>
                Melhoramos a velocidade, usabilidade e visibilidade do seu site
                nos buscadores.
              </p>
            </div>
          </li>
